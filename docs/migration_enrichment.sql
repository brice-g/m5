...
ALTER TABLE demandes 
    ADD COLUMN IF NOT EXISTS langue VARCHAR(5) DEFAULT NULL,,
...
CREATE INDEX IF NOT EXISTS idx_demandes_langue ON demandes(langue);
CREATE INDEX IF NOT EXISTS idx_demandes_routed_priority ON demandes(routed_priority);
